...
Mock.mock(/\/api\/manager\/report\/batchDelete/, 'post', reportAPI.batchremove)
...
//用户相关
Mock.mock(/\/api\/user\/GetUsers/, 'get', UserAPI.GetUserList)
Mock.mock(/\/api\/user\/GetUser/, 'get', UserAPI.getUserDetail)
Mock.mock(/\/api\/user\/UpdateUser/, 'post', UserAPI.editUser)
Mock.mock(/\/api\/user\/ResetUserPass/, 'post', UserAPI.resetPass)
Mock.mock(/\/api\/user\/updateUserPass/, 'post', UserAPI.updateUserPass)
Mock.mock(/\/api\/user\/DeleteUser/, 'post', UserAPI.deleteUser)
Mock.mock(/\/api\/user\/deleteUsers/, 'post', UserAPI.batchDeleteUser)
// 文章相关
